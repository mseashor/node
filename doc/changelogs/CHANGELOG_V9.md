...
<a id="9.6.0"></a>
## 2018-02-21, Version 9.6.0 (Current), @MylesBorins
...
* [[`09cf65c97b`](https://github.com/nodejs/node/commit/09cf65c97b)] - **(SEMVER-MINOR)** **async_hooks**: deprecate unsafe emit{Before,After} (Ali Ijaz Sheikh) [#18513](https://github.com/nodejs/node/pull/18513)
* [[`79b35fdc22`](https://github.com/nodejs/node/commit/79b35fdc22)] - **(SEMVER-MINOR)** **async_hooks**: rename PromiseWrap.parentId (Ali Ijaz Sheikh) [#18633](https://github.com/nodejs/node/pull/18633)
...
* [[`1072f02bde`](https://github.com/nodejs/node/commit/1072f02bde)] - **benchmark**: improve compare output (Ruben Bridgewater) [#18597](https://github.com/nodejs/node/pull/18597)
...
* [[`4073ab11e9`](https://github.com/nodejs/node/commit/4073ab11e9)] - **buffer**: remove obsolete NaN check (Ruben Bridgewater) [#18744](https://github.com/nodejs/node/pull/18744)
* [[`a9581217a7`](https://github.com/nodejs/node/commit/a9581217a7)] - **buffer**: simplify check size in assertSize (Mihail Bodrov) [#18665](https://github.com/nodejs/node/pull/18665)
* [[`d2f7468b98`](https://github.com/nodejs/node/commit/d2f7468b98)] - **build**: no longer have v8-debug.h as dependency. (Yang Guo) [#18677](https://github.com/nodejs/node/pull/18677)
* [[`e080d7d6b1`](https://github.com/nodejs/node/commit/e080d7d6b1)] - **build**: do not suppress output in make doc-only (Joyee Cheung) [#18507](https://github.com/nodejs/node/pull/18507)
...
* [[`30413ee53a`](https://github.com/nodejs/node/commit/30413ee53a)] - **build,win**: replace run-python subroutine with single find_python call (Nikolai Vavilov) [#18621](https://github.com/nodejs/node/pull/18621)
* [[`5f59634c55`](https://github.com/nodejs/node/commit/5f59634c55)] - **child_process**: fix stdio sockets creation (Santiago Gimeno) [#18701](https://github.com/nodejs/node/pull/18701)
...
* [[`e2315cab28`](https://github.com/nodejs/node/commit/e2315cab28)] - **deps**: V8: backport 76c3ac5 from upstream (Ali Ijaz Sheikh) [#18298](https://github.com/nodejs/node/pull/18298)
...
* [[`b9b58100e0`](https://github.com/nodejs/node/commit/b9b58100e0)] - **doc**: fix nits in tools/doc/README.md (Vse Mozhet Byt) [#18874](https://github.com/nodejs/node/pull/18874)
* [[`a40c28b8f3`](https://github.com/nodejs/node/commit/a40c28b8f3)] - **doc**: fix minor grammar/typographical issues in onboarding.md (Rich Trott) [#18847](https://github.com/nodejs/node/pull/18847)
* [[`3cc0b7c2a0`](https://github.com/nodejs/node/commit/3cc0b7c2a0)] - **doc**: update onboarding.md for faster exercise completion (Rich Trott) [#18846](https://github.com/nodejs/node/pull/18846)
* [[`88bb203b83`](https://github.com/nodejs/node/commit/88bb203b83)] - **doc**: improved documentation for fs.unlink() (dustinnewman98) [#18843](https://github.com/nodejs/node/pull/18843)
* [[`fe15805d31`](https://github.com/nodejs/node/commit/fe15805d31)] - **doc**: fix broken link in pull-requests.md (Justin Lee) [#18873](https://github.com/nodejs/node/pull/18873)
* [[`6be701a07f`](https://github.com/nodejs/node/commit/6be701a07f)] - **doc**: fix typo in http2.md (Vse Mozhet Byt) [#18872](https://github.com/nodejs/node/pull/18872)
* [[`7d0c04aed9`](https://github.com/nodejs/node/commit/7d0c04aed9)] - **doc**: refactor manpage to use mdoc(7) macros (Alhadis) [#18559](https://github.com/nodejs/node/pull/18559)
* [[`f5806c2bb1`](https://github.com/nodejs/node/commit/f5806c2bb1)] - **doc**: mark accessing IPC channel fd as undefined (Bartosz Sosnowski) [#17545](https://github.com/nodejs/node/pull/17545)
* [[`15ba09396b`](https://github.com/nodejs/node/commit/15ba09396b)] - **doc**: fix minor typos in GOVERNANCE.md (Rich Trott) [#18829](https://github.com/nodejs/node/pull/18829)
* [[`e0711773de`](https://github.com/nodejs/node/commit/e0711773de)] - **doc**: add Yihong Wang to collaborators (Yihong Wang) [#18824](https://github.com/nodejs/node/pull/18824)
* [[`983fe33229`](https://github.com/nodejs/node/commit/983fe33229)] - **doc**: warn against concurrent http2stream.respondWithFD (Anna Henningsen) [#18762](https://github.com/nodejs/node/pull/18762)
* [[`a14186b0c8`](https://github.com/nodejs/node/commit/a14186b0c8)] - **doc**: activate `no-multiple-empty-lines` rule (Ruben Bridgewater) [#18747](https://github.com/nodejs/node/pull/18747)
* [[`3eb31baf75`](https://github.com/nodejs/node/commit/3eb31baf75)] - **doc**: note that linting is required in releases.md (Gibson Fahnestock) [#18776](https://github.com/nodejs/node/pull/18776)
* [[`71dd80b021`](https://github.com/nodejs/node/commit/71dd80b021)] - **doc**: remove extra space in README.md (Matheus Marchini) [#18822](https://github.com/nodejs/node/pull/18822)
* [[`67c1811210`](https://github.com/nodejs/node/commit/67c1811210)] - **doc**: update crypo Certficate class. (Antoine AMARA) [#18721](https://github.com/nodejs/node/pull/18721)
* [[`606a36114e`](https://github.com/nodejs/node/commit/606a36114e)] - **doc**: move Fedor to TSC Emeritus (Myles Borins) [#18752](https://github.com/nodejs/node/pull/18752)
* [[`6b0ce80725`](https://github.com/nodejs/node/commit/6b0ce80725)] - **doc**: add mmarchini to collaborators (Matheus Marchini) [#18740](https://github.com/nodejs/node/pull/18740)
* [[`b5e09c42cc`](https://github.com/nodejs/node/commit/b5e09c42cc)] - **doc**: mark NAPI_AUTO_LENGTH as code (Tobias Nießen) [#18697](https://github.com/nodejs/node/pull/18697)
* [[`edcddebf63`](https://github.com/nodejs/node/commit/edcddebf63)] - **doc**: add error check to fs example (Evan Lucas) [#18681](https://github.com/nodejs/node/pull/18681)
* [[`dc6c75dcc5`](https://github.com/nodejs/node/commit/dc6c75dcc5)] - **doc**: fix exporting a function example (Aonghus O Nia) [#18661](https://github.com/nodejs/node/pull/18661)
* [[`42f65e6fb7`](https://github.com/nodejs/node/commit/42f65e6fb7)] - **doc**: add history for url.parse (Steven) [#18685](https://github.com/nodejs/node/pull/18685)
* [[`b192190935`](https://github.com/nodejs/node/commit/b192190935)] - **doc**: fix links to Style Guide and CPP Style Guide (Justin Lee) [#18683](https://github.com/nodejs/node/pull/18683)
* [[`ec1e3b2cfe`](https://github.com/nodejs/node/commit/ec1e3b2cfe)] - **doc**: add devsnek to collaborators (Gus Caplan) [#18679](https://github.com/nodejs/node/pull/18679)
* [[`24d51621ce`](https://github.com/nodejs/node/commit/24d51621ce)] - **doc**: fix links in YAML metadata of assert.md (Vse Mozhet Byt) [#18670](https://github.com/nodejs/node/pull/18670)
* [[`97b5c1f796`](https://github.com/nodejs/node/commit/97b5c1f796)] - **doc**: add missing meta for createCipheriv (Tobias Nießen) [#18651](https://github.com/nodejs/node/pull/18651)
* [[`b4d04a87eb`](https://github.com/nodejs/node/commit/b4d04a87eb)] - **doc**: fix description of createDecipheriv (Tobias Nießen) [#18651](https://github.com/nodejs/node/pull/18651)
...
* [[`bac9487f73`](https://github.com/nodejs/node/commit/bac9487f73)] - **fs**: remove useless comments which duplicate names of variables (Sergey Golovin) [#18739](https://github.com/nodejs/node/pull/18739)
* [[`4e66bc30bd`](https://github.com/nodejs/node/commit/4e66bc30bd)] - **fs**: replace magic numbers by named constants (Sergey Golovin) [#18757](https://github.com/nodejs/node/pull/18757)
* [[`5e3c792c74`](https://github.com/nodejs/node/commit/5e3c792c74)] - **fs**: make URL paths no longer experimental (James M Snell) [#18591](https://github.com/nodejs/node/pull/18591)
* [[`f19bd9e17c`](https://github.com/nodejs/node/commit/f19bd9e17c)] - **fs**: fix stack overflow in fs.readdirSync (Joyee Cheung) [#18647](https://github.com/nodejs/node/pull/18647)
* [[`7bfd0c772c`](https://github.com/nodejs/node/commit/7bfd0c772c)] - **http**: simplify checkInvalidHeaderChar (Seth Brenith) [#18381](https://github.com/nodejs/node/pull/18381)
* [[`c247cb02a1`](https://github.com/nodejs/node/commit/c247cb02a1)] - **http**: add options to http.createServer() (Peter Marton) [#15752](https://github.com/nodejs/node/pull/15752)
...
* [[`5e778b4c76`](https://github.com/nodejs/node/commit/5e778b4c76)] - **http2**: use `_final` instead of `on('finish')` (Anna Henningsen) [#18609](https://github.com/nodejs/node/pull/18609)
* [[`af31f591c7`](https://github.com/nodejs/node/commit/af31f591c7)] - **http2**: add req and res options to server creation (Peter Marton) [#15560](https://github.com/nodejs/node/pull/15560)
* [[`7806c51f30`](https://github.com/nodejs/node/commit/7806c51f30)] - **http2**: add http fallback options to .createServer (Peter Marton) [#15752](https://github.com/nodejs/node/pull/15752)
* [[`cd080ef530`](https://github.com/nodejs/node/commit/cd080ef530)] - **(SEMVER-MINOR)** **https**: add extra options to Agent#getName() (Jeff Principe) [#16402](https://github.com/nodejs/node/pull/16402)
...
* [[`36f71836dc`](https://github.com/nodejs/node/commit/36f71836dc)] - **(SEMVER-MINOR)** **lib**: allow process kill by signal number (Sam Roberts) [#16944](https://github.com/nodejs/node/pull/16944)
* [[`97e71736f7`](https://github.com/nodejs/node/commit/97e71736f7)] - **lib**: replace `eval` with `vm.runInThisContext` (Myles Borins) [#18623](https://github.com/nodejs/node/pull/18623)
* [[`6604a2ddb1`](https://github.com/nodejs/node/commit/6604a2ddb1)] - **lib**: switch to Number.isNaN (Ruben Bridgewater) [#18744](https://github.com/nodejs/node/pull/18744)
* [[`7bd5eb30a9`](https://github.com/nodejs/node/commit/7bd5eb30a9)] - **lib**: set process.execPath on OpenBSD (Aaron Bieber) [#18543](https://github.com/nodejs/node/pull/18543)
* [[`cc1df6db98`](https://github.com/nodejs/node/commit/cc1df6db98)] - **lib**: provide proper deprecation code (Ruben Bridgewater) [#18694](https://github.com/nodejs/node/pull/18694)
...
* [[`d1d74050c1`](https://github.com/nodejs/node/commit/d1d74050c1)] - **loader**: fix up #18394 (Gus Caplan) [#18509](https://github.com/nodejs/node/pull/18509)
...
* [[`144be3d307`](https://github.com/nodejs/node/commit/144be3d307)] - **net**: simplify net.Socket#end() (Anna Henningsen) [#18708](https://github.com/nodejs/node/pull/18708)
* [[`a5596b1be4`](https://github.com/nodejs/node/commit/a5596b1be4)] - **net**: remove Socket.prototoype.read (Anna Henningsen) [#18568](https://github.com/nodejs/node/pull/18568)
...
* [[`be08ca7ac5`](https://github.com/nodejs/node/commit/be08ca7ac5)] - **path**: replace duplicate conditions by functions (Sergey Golovin) [#18693](https://github.com/nodejs/node/pull/18693)
* [[`71e84b4653`](https://github.com/nodejs/node/commit/71e84b4653)] - **path**: replace "magic" numbers by readable constants (Sergey Golovin) [#18654](https://github.com/nodejs/node/pull/18654)
...
* [[`fe8cfc3b71`](https://github.com/nodejs/node/commit/fe8cfc3b71)] - **src**: add nullptr check for session in DEBUG macro (Daniel Bevenius) [#18815](https://github.com/nodejs/node/pull/18815)
* [[`a64917b4dc`](https://github.com/nodejs/node/commit/a64917b4dc)] - **src**: factor out some common vm functions (Timothy Gu) [#17560](https://github.com/nodejs/node/pull/17560)
* [[`256940a0bf`](https://github.com/nodejs/node/commit/256940a0bf)] - **src**: flatten ContextifyContext (Gus Caplan) [#17560](https://github.com/nodejs/node/pull/17560)
* [[`5ce0066f5e`](https://github.com/nodejs/node/commit/5ce0066f5e)] - **src**: replace var for let / const. (alejandro estrada) [#18649](https://github.com/nodejs/node/pull/18649)
* [[`6340b11a6a`](https://github.com/nodejs/node/commit/6340b11a6a)] - **src**: add "icu::" prefix before ICU symbols (Steven R. Loomis) 
* [[`a62789b5fa`](https://github.com/nodejs/node/commit/a62789b5fa)] - **src**: don't abort when package.json is a directory (Ben Noordhuis) [#18270](https://github.com/nodejs/node/pull/18270)
...
* [[`8215f677f2`](https://github.com/nodejs/node/commit/8215f677f2)] - **stream**: fix misleading error message (Luigi Pinca) [#18604](https://github.com/nodejs/node/pull/18604)
...
* [[`bc156daf60`](https://github.com/nodejs/node/commit/bc156daf60)] - **test**: http2 client settings invalid callback (Trivikram) [#18850](https://github.com/nodejs/node/pull/18850)
* [[`662d0cd94f`](https://github.com/nodejs/node/commit/662d0cd94f)] - **test**: http2 client ping errors (Trivikram) [#18849](https://github.com/nodejs/node/pull/18849)
* [[`dbd2eb931c`](https://github.com/nodejs/node/commit/dbd2eb931c)] - **test**: http2 client operations after destroy (Trivikram) [#18845](https://github.com/nodejs/node/pull/18845)
* [[`e7a415dd21`](https://github.com/nodejs/node/commit/e7a415dd21)] - **test**: refactor parallel/test-tls-pause (juggernaut451) [#18714](https://github.com/nodejs/node/pull/18714)
* [[`7812654267`](https://github.com/nodejs/node/commit/7812654267)] - **test**: refactor stream-*-constructor-set-methods (Luigi Pinca) [#18817](https://github.com/nodejs/node/pull/18817)
* [[`13ff5088d7`](https://github.com/nodejs/node/commit/13ff5088d7)] - **test**: stdio pipe behavior tests (Bartosz Sosnowski) [#18614](https://github.com/nodejs/node/pull/18614)
* [[`1fb4cc9d9a`](https://github.com/nodejs/node/commit/1fb4cc9d9a)] - **test**: refactor parallel/test-tls-0-dns-altname (juggernaut451) [#18803](https://github.com/nodejs/node/pull/18803)
* [[`6f37c4dee9`](https://github.com/nodejs/node/commit/6f37c4dee9)] - **test**: add common.skipIfEslintMissing (Myles Borins) [#18807](https://github.com/nodejs/node/pull/18807)
* [[`d8897672aa`](https://github.com/nodejs/node/commit/d8897672aa)] - **test**: fix warnings in addon tests (Ali Ijaz Sheikh) [#18810](https://github.com/nodejs/node/pull/18810)
* [[`de7a24c319`](https://github.com/nodejs/node/commit/de7a24c319)] - **test**: refactor parallel/test-tls-addca (juggernaut451) [#18798](https://github.com/nodejs/node/pull/18798)
* [[`91fd98bd10`](https://github.com/nodejs/node/commit/91fd98bd10)] - **test**: refactor of test-tls-over-http-tunnel (juggernaut451) [#18784](https://github.com/nodejs/node/pull/18784)
* [[`80e1cb7ed5`](https://github.com/nodejs/node/commit/80e1cb7ed5)] - **test**: make tls test more rigorous (Ben Noordhuis) [#18792](https://github.com/nodejs/node/pull/18792)
* [[`4cb1af2377`](https://github.com/nodejs/node/commit/4cb1af2377)] - **test**: reduce benchmark test run time (juggernaut451) [#18787](https://github.com/nodejs/node/pull/18787)
* [[`e0096ed902`](https://github.com/nodejs/node/commit/e0096ed902)] - **test**: try to connect after server was closed (Leko) [#18257](https://github.com/nodejs/node/pull/18257)
* [[`87d5741c67`](https://github.com/nodejs/node/commit/87d5741c67)] - **test**: wrap countdown callback in common.mustCall (Bamieh) [#18506](https://github.com/nodejs/node/pull/18506)
* [[`1a978407d8`](https://github.com/nodejs/node/commit/1a978407d8)] - **test**: update a few tests to work on OpenBSD (Aaron Bieber) [#18543](https://github.com/nodejs/node/pull/18543)
* [[`cca4062445`](https://github.com/nodejs/node/commit/cca4062445)] - **test**: add lib path env when node_shared=true (Yihong Wang) [#18626](https://github.com/nodejs/node/pull/18626)
* [[`e1eccc34b4`](https://github.com/nodejs/node/commit/e1eccc34b4)] - **test**: add multiline repl input regression test (cjihrig) [#18718](https://github.com/nodejs/node/pull/18718)
* [[`59142413ed`](https://github.com/nodejs/node/commit/59142413ed)] - **test**: remove unnecessary timer (cjihrig) [#18719](https://github.com/nodejs/node/pull/18719)
* [[`c6525b6445`](https://github.com/nodejs/node/commit/c6525b6445)] - **test**: add crypto check to test-benchmark-tls (Daniel Bevenius) [#18724](https://github.com/nodejs/node/pull/18724)
* [[`4d9070567e`](https://github.com/nodejs/node/commit/4d9070567e)] - **test**: fix missing param in benchmark-timers (Anatoli Papirovski) [#18734](https://github.com/nodejs/node/pull/18734)
* [[`bd2edd758f`](https://github.com/nodejs/node/commit/bd2edd758f)] - **test**: fix and improve error message (Kevin Caulfield) [#18449](https://github.com/nodejs/node/pull/18449)
* [[`4448eea842`](https://github.com/nodejs/node/commit/4448eea842)] - **test**: add useful info to error msg and refactor (Chin Huang) [#18541](https://github.com/nodejs/node/pull/18541)
* [[`6790a72a00`](https://github.com/nodejs/node/commit/6790a72a00)] - **test**: fix flaky repl-timeout-throw (Santiago Gimeno) [#18692](https://github.com/nodejs/node/pull/18692)
* [[`a822814bb7`](https://github.com/nodejs/node/commit/a822814bb7)] - **test**: properly tag anonymous namespaces (Michael Dawson) [#18583](https://github.com/nodejs/node/pull/18583)
* [[`af3841be25`](https://github.com/nodejs/node/commit/af3841be25)] - **test**: fix flaky timers-block-eventloop test (Anatoli Papirovski) [#18567](https://github.com/nodejs/node/pull/18567)
...
* [[`b305cea8e2`](https://github.com/nodejs/node/commit/b305cea8e2)] - **test,benchmark,doc**: enable dot-notation rule (Ruben Bridgewater) [#18749](https://github.com/nodejs/node/pull/18749)
...
* [[`e05ecaad07`](https://github.com/nodejs/node/commit/e05ecaad07)] - **tls**: tls_wrap causes debug assert in vector (Kyle Farnung) [#18830](https://github.com/nodejs/node/pull/18830)
...
* [[`51113365ac`](https://github.com/nodejs/node/commit/51113365ac)] - **tools**: custom eslint autofix for inspector-check.js (Shobhit Chittora) [#16646](https://github.com/nodejs/node/pull/16646)
* [[`1c5a430f97`](https://github.com/nodejs/node/commit/1c5a430f97)] - **tools**: auto fix custom crypto-check eslint rule (Shobhit Chittora) [#16647](https://github.com/nodejs/node/pull/16647)
* [[`90152ebd2e`](https://github.com/nodejs/node/commit/90152ebd2e)] - **tools**: fix eslint isRequired (Ruben Bridgewater) [#18729](https://github.com/nodejs/node/pull/18729)
...
* [[`cf845d4000`](https://github.com/nodejs/node/commit/cf845d4000)] - **url**: simplify constructor URLSearchParams. Remove needless check null (Mihail Bodrov) [#18700](https://github.com/nodejs/node/pull/18700)
...
* [[`1a0168ec0f`](https://github.com/nodejs/node/commit/1a0168ec0f)] - **vm**: flip Module#link's signature (Gus Caplan) [#18471](https://github.com/nodejs/node/pull/18471)
* [[`928ecc8150`](https://github.com/nodejs/node/commit/928ecc8150)] - **vm**: add modules (Gus Caplan) [#17560](https://github.com/nodejs/node/pull/17560)
